...
public class User_Adapter extends RecyclerView.Adapter<User_Adapter.UHolder>{
    Context ct;
    ArrayList<User_item> al;

    User_Adapter(Context cont , ArrayList<User_item> al)
    {
        this.ct = cont;
        this.al = al;
    ...
    @Override
    public UHolder onCreateViewHolder(ViewGroup parent , int viewType)
    {
    ...
    @Override
    public void onBindViewHolder(User_Adapter.UHolder holder , final int position)
    {
        ...
        final User_item p1 = al.get(position);
