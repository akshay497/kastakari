...
public class Service_Available extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_show_availble_provider);
        ...
        FirebaseDatabase.getInstance().getReference().child("Seeker").child(categorie).addListenerForSingleValueEvent(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                md = new User_Adapter(Service_Available.this , al);
                rv.setAdapter(md);
    ...
    {
        startActivity(new Intent(Service_Available.this , Home_Activity.class));
    }
}
